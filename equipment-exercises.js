(function () {
  ...
  add(
    "Triceps",
    "Functional trainer + curl bar + bench",
    ["Functional trainer", "Curl bar", "Bench"],
    [
  ...
  add(
    ...
    "Functional trainer + curl bar",
    ["Functional trainer", "Curl bar"],
    ["Cable upright row with curl bar", "Cable front raise with curl bar"],
  );
  add(
    "Back and Lats",
    "Functional trainer + curl bar",
    ["Functional trainer", "Curl bar"],
    ["Bent-over cable row with curl bar", "Cable high row with curl bar"],
  );

  add(
    "Biceps",
    "Functional trainer + straight bar",
    ["Functional trainer", "Straight bar"],
    [
  ...
  add(
    ...
    "Functional trainer + straight bar",
    ["Functional trainer", "Straight bar"],
    ["Straight-bar triceps pushdown", "Reverse-grip straight-bar pushdown"],
  );
  add(
    "Shoulders and Rotator Cuff",
    "Functional trainer + straight bar",
  ...
  add(
    "Back and Lats",
    "Functional trainer + low row handle",
    ["Functional trainer", "Low row handle"],
    [
  ...
  add(
    "Triceps",
    "Functional trainer + triceps rope",
    ["Functional trainer", "Triceps rope"],
    [
  ...
  add(
    ...
    "Functional trainer + triceps rope",
    ["Functional trainer", "Triceps rope"],
    ["Rope hammer curl", "Rope cable curl", "High rope curl"],
  );
  add(
    "Back and Lats",
    "Functional trainer + triceps rope",
    ["Functional trainer", "Triceps rope"],
    ["Rope straight-arm pulldown", "Rope high row"],
  );
  add(
    "Shoulders and Rotator Cuff",
    "Functional trainer + triceps rope",
    ["Functional trainer", "Triceps rope"],
    ["Face pull", "Face pull with external rotation", "Rope cable upright row"],
  );
  add(
    "Core",
    "Functional trainer + triceps rope",
    ["Functional trainer", "Triceps rope"],
    ["Kneeling cable crunch", "Standing rope cable crunch"],
  );
  add(
    "Glutes and Hips",
    "Functional trainer + triceps rope",
  ...
  add(
    "Glutes and Hips",
    "Functional trainer + ankle strap",
    ["Functional trainer", "Ankle straps"],
    [
  ...
  add(
    ...
    "Functional trainer + ankle strap",
    ["Functional trainer", "Ankle straps"],
    ["Standing cable leg extension", "Seated cable leg extension"],
  );
  add(
    "Core",
    "Functional trainer + ankle strap",
    ["Functional trainer", "Ankle straps"],
    ["Cable resisted knee drive", "Cable mountain climber"],
  );
  ...
  add(
    ...
    "Kettlebell",
    ["Kettlebell"],
    ["Kettlebell biceps curl", "Kettlebell hammer curl"],
  );
  add(
    "Triceps",
    "Kettlebell + bench",
  ...
  add(
    ...
    "Back extension machine",
    ["Back extension machine"],
    ["Glute-biased back extension", "Rounded-back hip extension"],
    { backCaution: true },
  );
  add(
    "Core",
  ...
  add(
    ...
    "Body weight + bench",
    ["Bench", "Body weight"],
    ["Bench Copenhagen plank", "Bench-supported mountain climber"],
  );
  ...
  add(
    ...
    "Smith machine + bench",
    ["Smith machine", "Bench"],
    ["Smith machine box squat", "Smith machine Bulgarian split squat"],
  );
  add(
    "Hamstrings",
    "Smith machine",
  ...
  add(
    ...
    "Smith machine + bench",
    ["Smith machine", "Bench"],
    ["Smith machine close-grip bench press", "Smith machine JM press"],
  );
  add(
    "Shoulders and Rotator Cuff",
    "Smith machine + bench",
  ...
  add(
    ...
    [
      ...
      { name: "Smith machine inverted row", backCaution: false },
    ],
    { backCaution: true },
  );
  add(
